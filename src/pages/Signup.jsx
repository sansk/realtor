      ...
      <div className="m-10 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-10 w-5/6 md:w-full lg:w-4/6 m-auto">
          <form className="w-full">
            ...
            <input type="text" className="w-full rounded-md mb-2" placeholder="Full Name" id="fullName" value={fullName} onChange={onChange}/>
            ...
            <button type="submit" className="w-full bg-sky-600 text-white py-3 rounded-md mb-2 font-semibold hover:bg-sky-700 transition duration-200 ease-in-out">Sign Up</button>
          </form>
